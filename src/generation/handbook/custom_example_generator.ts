...
export async function generateCustomExample(input: CustomExampleInput): Promise<string> {
  ...
  const prompt = [
    ...
    ``,
    `7. PŁYNNOŚĆ DIALOGU (NOWE)`,
    `   - Zrób co najmniej 1 fragment 3–4 wymian BEZ didaskaliów między kwestiami (płynna rozmowa).`,
    `   - Didaskalia/gesty maksymalnie co 2–3 kwestie – nie wtrącaj ich po KAŻDEJ linii.`,
    `   - Jeśli używasz gestów, skracaj je (1 krótka fraza).`,
    ``,
    `═══════════════════════════════════════════════════════════════`,
